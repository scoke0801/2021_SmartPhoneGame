...
public class Sound {
    ...
    private static final int[] SOUND_IDS = {
            ...
            R.raw.e_move, R.raw.e_water_fall
    };
    ...
    public static void init(Context context){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)  {
            ...
            soundPool = new SoundPool.Builder()
                    ...
                    .setMaxStreams(10)
                    .build();
            bgm = new SoundPool.Builder()
                    .setAudioAttributes(audioAttributes[1])
                    .setMaxStreams(10)
                    .build();
        }
        else{
    ...
    public static int playBgm(int resId){
        Log.d(TAG, "Sound.play" + resId);
        int soundId = soundIdMap.get(resId);
        int streamId = bgm.play(soundId, 1f, 1f, 1, 1, 1f);
        return streamId;
    }
}
